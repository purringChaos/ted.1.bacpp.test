 ...
 */
public class I03BinaryConversionComponent extends I03BinaryTestComponent {
	
	private static final Logger LOGGER = LogManager.getLogger(I03BinaryConversionComponent.class);
			...
			if (isRequest) {
				...
				for(SignalProcessingEventType.AcquiredSignal signal : event.getAcquiredSignal()) {
					if (signal.getBinaryData() != null) {
						...
						tv.blackarrow.cpp.signal.signaling.SCTE35PointDescriptorType i01Scte35PointDescriptorType = convertToI01SCTE35PointDescriptor(scte35Pt);
						Scte35BinaryUtil.decodeScte35BinaryData(new String(encoded), i01Scte35PointDescriptorType, pts, pts_adjustment);
						signal.setSCTE35PointDescriptor(convertToI03SCTE35PointDescriptor(i01Scte35PointDescriptorType));
						...
						String encodedStr = Scte35BinaryUtil.encodeScte35DataToBinary(convertToI01SCTE35PointDescriptor(signal.getSCTE35PointDescriptor()), "", 
								Scte35BinaryUtil.toBitString(0, 33));
