...
public class CRC32Mpeg2 {
    ...
    private static final int crctab[] = { 0x00000000, 0x04C11DB7, 0x09823B6E, 0x0D4326D9, 0x130476DC, 0x17C56B6B, 0x1A864DB2,
    ...
    /**
     * Calculates the CRC-32 value (MPEG-2 format) for the byte array passed in
     * 
     * @param bytes
     *            bytes to calculate the CRC-32 (MPEG-2 format) for
     * @return CRC-32 value (MPEG-2 format)
     */
