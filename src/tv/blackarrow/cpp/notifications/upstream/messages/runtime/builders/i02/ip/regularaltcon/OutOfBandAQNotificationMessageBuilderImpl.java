...
public class OutOfBandAQNotificationMessageBuilderImpl extends BaseNotificationMessageBuilderImpl implements EsamNotificationMessageBuilder {

	private static OutOfBandAQNotificationMessageBuilderImpl instance = new OutOfBandAQNotificationMessageBuilderImpl();

	private static final Logger LOG = LogManager.getLogger(OutOfBandAQNotificationMessageBuilderImpl.class);

	public static OutOfBandAQNotificationMessageBuilderImpl getInstance() {
		return instance;
	}
	...
	private String createI03SchemaUpstreamNotificatonMessage(NotificationMessage notificationMessage, SegmentType segmentType, String action, boolean isProgramRunoverSignal,
		...
		try {
			...
			if (isProgramRunoverSignal) {
				//long notifiactionTimeInSec = notificationMessage.getNotificationScheduledTime();
				//XMLGregorianCalendar notificationTime = getXMLGregorianCalenderTime(notifiactionTimeInSec * 1000);
